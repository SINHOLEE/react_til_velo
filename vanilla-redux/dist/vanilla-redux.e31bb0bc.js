...
var increse_btn = document.querySelector(".increase");
var decrese_btn = document.querySelector(".decrease"); // action 타입 선언

var TOGGLE_SWITCH = "TOGGLE_SWITCH";
var INCREASE = "INCREASE";
var DECREASE = "DECREASE"; // action 함수 선언
...
render(); // store에  render 함수 구독하기
// 스토어의 상태가 바뀔때마다 render함수를 호출하기 위해 구독모델을 사용

store.subscribe(render); // 액션발생 -> dispatch

toggle.addEventListener("click", function () {
  store.dispatch(toggleSwitch());
});
increse_btn.addEventListener("click", function () {
  store.dispatch(increase(20));
});
decrese_btn.addEventListener("click", function () {
  store.dispatch(decrease());
});
},{"redux":"node_modules/redux/es/redux.js"}],"../../../.nvm/versions/node/v12.18.3/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
